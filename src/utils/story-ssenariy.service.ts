...
//     }
//
//     let result: StorySsenariyModel = await UploadsRepository.getOrderBySsenariyPosition({
...
//
//       if (nextSsenariy) {
//         result = await UploadsRepository.create({
//           user_id: user_id,
...
//
//     if (isUpdateable) {
//       let result = await UploadsRepository.update(storySsenariy);
//       storySsenariy = {
//         ...result,
