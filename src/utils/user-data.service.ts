// import {LevelRepository, PrizeRepository, RolesRepository, MoviesRepository} from "../repository";
...
//         const phoneExists: boolean = await RolesRepository.checkPhoneExists(phone, month);
//         if (phoneExists) {
...
//         const user: UserDataModel = await RolesRepository.getUserDataByPhoneAndMonth(phone, month);
...
//             await MoviesRepository.insertUserLevels(newLevels);
//         }
//     }
//
...
//             }
//         }
//         await RolesRepository.updateUserData(phone, amount, month, currentLevelId);
//     }
//
...
//             }
//         }
//         await RolesRepository.insertUserData(phone, amount, month, currentLevelId);
//     }
//
