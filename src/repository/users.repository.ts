...
import { pgPoolQuery, QueryParams, UsersModel } from '..';

export class UsersRepository {

    static async getAll(params: QueryParams): Promise<UsersModel[]> {
    ...
    static async getById(id: number): Promise<UsersModel> {
        const sql = `SELECT u.user_id,
                            u.language,
                            u.activate_date,
                            u.status
    ...
    static async create(params: UsersModel): Promise<UsersModel> {
